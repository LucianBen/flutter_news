...
class NewsHeadline extends StatefulWidget {
  @override
  _NewsHeadlineState createState() => _NewsHeadlineState();
}
      ...
      return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            newsProvider.topItems = (data[0]['item'] as List).cast(); //置顶新闻
            newsProvider.newsItems = (data[1]['item'] as List).cast(); //热点新闻
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (newsProvider.newsItems[index]['showType'] == '0' &&
                            newsProvider.newsItems[index]['style']
                                    ['recomReason'] !=
                                null) {
                          //热点展示
                          return NewsHeadlineItemsHot(
                              newsProvider.newsItems, index);
                        } else if (newsProvider.newsItems[index]['showType'] ==
                                '0' &&
